        ...
        EventBus.on(EVENT.command,function(command){
            ...
            switch (command){
                ...
                case COMMAND.showAbout:
                    ...
                    dialog.setText("BassoonTrackerDesktop//Old School Amiga MOD and XM tracker/in plain javascript//©2017-2023 by Steffest, ported to Electron by denomis//version " + version + "//Fork me on Github!");
